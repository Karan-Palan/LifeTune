...
const HealthAgeCalculator = () => {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', color: '#333',background: 'linear-gradient(to bottom, #000000, #111111)', backgroundColor: '#111111', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' ,  textAlign: 'center'}}>
            <Header/>
            <div style={{ border: '1px solid #ccc', padding: '20px', borderRadius: '10px', marginBottom: '40px', marginTop: '15px' ,  textAlign: 'center'}}>
                <div style={{ marginBottom: '15px' }}>
                    ...
                    <input
                        ...
                        style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}
                    />
                </div>
                ...
                <div style={{ marginBottom: '15px', color:'white' }}>
                    ...
                    <select id="bmi" value={BMI} onChange={(e) => setBMI(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px', color:'white' }}>
                    ...
                    <select id="sleep" value={sleep} onChange={(e) => setSleep(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px', color:'white' }}>
                    ...
                    <select id="cholesterol" value={cholesterol} onChange={(e) => setCholesterol(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px', color:'white' }}>
                    ...
                    <select id="bloodPressure" value={bloodPressure} onChange={(e) => setBloodPressure(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px', color:'white' }}>
                    ...
                    <select id="smoking" value={smoking} onChange={(e) => setSmoking(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px' , color:'white'}}>
                    ...
                    <select id="bloodGlucose" value={bloodGlucose} onChange={(e) => setBloodGlucose(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px', color:'white' }}>
                    ...
                    <select id="socialConnection" value={socialConnection} onChange={(e) => setSocialConnection(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px' , color:'white'}}>
                    ...
                    <select id="stress" value={stress} onChange={(e) => setStress(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px' , color:'white'}}>
                    ...
                    <select id="redFoods" value={redFoods} onChange={(e) => setRedFoods(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
                ...
                <div style={{ marginBottom: '15px', color:'white' }}>
                    ...
                    <select id="strengthTraining" value={strengthTraining} onChange={(e) => setStrengthTraining(e.target.value)} style={{ padding: '5px', borderRadius: '5px', border: '1px solid #f5f5f5' }}>
